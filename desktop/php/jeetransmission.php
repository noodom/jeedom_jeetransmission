...
sendVarToJS('eqType', 'jeetransmission');
$eqLogics = eqLogic::byType('jeetransmission');
...
<div class="row row-overflow">
  ...
  <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
    <legend><i class="fa fa-table"></i>  {{Mes Transmissions}}
    </legend>
    <div class="eqLogicThumbnailContainer">
      ...
      foreach ($eqLogics as $eqLogic) {
        ...
        if (in_array($test, $files)) {
          ...
          $path = 'jeetransmission_icon';
        }
        echo '<img src="plugins/jeetransmission/doc/images/' . $path . '.png" height="105" width="95" />';
        echo "</center>";
        ...
        <form class="form-horizontal">
          <fieldset>
            <div class="form-group">
              <label class="col-sm-3 control-label">{{Equipement jeetransmission}}</label>
              <div class="col-sm-3">
                <input type="text" class="eqLogicAttr form-control" data-l1key="id" style="display : none;" />
                <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de l'équipement jeetransmission}}"/>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <input class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="link" type="text" placeholder="{{URL de consultation pour le modal'}}">
              </div>
            </div>
...
<?php include_file('desktop', 'jeetransmission', 'js', 'jeetransmission'); ?>
